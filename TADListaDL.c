...
Observaciones: El usuario ha creado una lista y l tiene la referencia a ella, p es una posicion valida de la lista, 
si esto no ha pasado se ocasionara un error.
*/
posicion Following (lista *l,posicion p)
{
...
Observaciones: El usuario ha creado una lista y l tiene la referencia a ella, p es una posicion valida de la lista, si esto no ha pasado se ocasionará un error.
*/
posicion Previous (lista *l,posicion p)
{
	if(ValidatePosition(l,p))
